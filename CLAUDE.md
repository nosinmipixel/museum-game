...
## Project Type
UPBGE Game Project (Blender Game Engine)

## Directory Structure
- Source/Assets/Scripts: Python game logic
- Main game scripts in root assets

## Coding Standards
- Use Python 3.x compatible code
- Follow UPBGE/KXGame conventions
...
## Important Notes
- Always check for KX_GameObject references
